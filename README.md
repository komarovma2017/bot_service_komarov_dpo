...
<!-- Вставить скриншот: регистрация, логин, /auth/me -->

### Работа Telegram бота
<!-- Вставить скриншот: /token команда, текстовый запрос, ответ LLM -->

### RabbitMQ Management UI
<!-- Вставить скриншот: активные очереди celery, подключения -->

### Результаты тестов
<!-- Вставить скриншот: pytest вывод для обоих сервисов -->
